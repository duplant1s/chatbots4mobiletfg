package chatbots4mobile_tfg.chatbots4mobiletfg.services;
...
import chatbots4mobile_tfg.chatbots4mobiletfg.models.*;
import chatbots4mobile_tfg.chatbots4mobiletfg.models.graph.*;
import chatbots4mobile_tfg.chatbots4mobiletfg.utils.Utils;
...
public class GraphDBService {
    ...
    //FeatureIntegration
    private IRI featureIntegrationIRI = factory.createIRI("https://schema.org/Action");
    
    //ParameterIntegration
    private IRI parameterIntegrationIRI = factory.createIRI("https://schema.org/PropertyValue");

    //Parameters objects
    private IRI booleanIRI = factory.createIRI("https://schema.org/Boolean");
    private IRI numberIRI = factory.createIRI("https://schema.org/Number");
    private IRI textIRI = factory.createIRI("https://schema.org/Text");
    private IRI geoCoordinatesIRI = factory.createIRI("https://schema.org/GeoCoordinates");
    private IRI contactPointIRI = factory.createIRI("https://schema.org/ContactPoint");
